...
userChaseHero;
userChaseHero.setAttribute("src", `${userCharacter.otsrc}`);
...
userFightHero.setAttribute("src", `${userCharacter.src}`);
...
console.log(userCharacter.otsrc);
...
function randomMonsterInfo() {
    ...
    fetch(monsterAPI)
        ...
        .then(function (data3) {
            ...
            imgCreateChase.setAttribute(
                "src",
                `../Images/Monsters/Chase/${data3.slug}.png`
            );
            ...
            imgCreateFight.setAttribute(
                "src",
                `../Images/Monsters/Fight/${data3.slug}.png`
            );
